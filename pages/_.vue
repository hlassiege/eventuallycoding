  ...
  <div class="px-4 mx-auto sm:px-6 xl:max-w-7xl xl:px-0 mt-10">
    ...
    <div>
      ...
      <div class="mt-4">
        ...
        <a :href="'https://facebook.com/sharer/sharer.php?u='+ siteMetadata.siteUrl +  article.path" target="_blank" rel="noopener" aria-label="">
        ...
        <a :href="'https://twitter.com/intent/tweet?url=' + siteMetadata.siteUrl +  article.path + '&text=' + article.title +'&via='+ siteMetadata.twitter_user" target="_blank" title="Share on Twitter" rel="noopener noreferrer">
