  ...
  <div class="px-4 mx-auto sm:px-6 xl:max-w-7xl xl:px-0 mt-10">
    ...
    <div>
      ...
      <div class="mt-4">
        ...
        <a :href="'https://twitter.com/intent/tweet?url=' + this.postLink + '&text=' + article.title +'&via='+ siteMetadata.twitter_user" target="_blank" title="Share on Twitter" rel="noopener noreferrer">
