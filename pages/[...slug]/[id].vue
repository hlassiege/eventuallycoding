        ...
        <div class="px-4 mx-auto sm:px-6 xl:max-w-7xl xl:px-0 mt-10 ">
            ...
            <p class="text-slate-400 text-center mb-5 ">
                <span v-if="article.alternates">
                    ...
                    <nuxt-link class="uppercase ml-1 text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" v-for="alternate in article.alternates" :to="alternate[Object.keys(alternate)[0]]">{{Object.keys(alternate)[0]}}</nuxt-link>
                </span>
            </p>
