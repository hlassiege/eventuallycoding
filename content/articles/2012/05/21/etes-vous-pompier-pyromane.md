...
description: "Vous connaissez les informaticiens pyromanes ? Ces personnes qui déclenchent eux-mêmes des incidents de production pour ensuite les résoudre ?"
date: "2012-05-21"
categories: 
  - "waza"
cover: "fire.jpg"
...
Vous connaissez la [pyromanie](http://fr.wikipedia.org/wiki/Pyromanie) ? Il s’agit d’une fascination pour le feu qui peut amener certains individus à déclencher eux-mêmes les incendies. Et vous avez peut-être entendu dire que parfois paradoxalement ce sont des pompiers qui allument ces feux, ce qui leur permet par la suite de se conduire en héros en allant les combattre.

Bon, mais ça ne vous rappelle rien ? Bon sang, mais c’est bien sûr, en informatique aussi les pompiers pyromanes existent !

Peut-être avez-vous déjà rencontré un de ces collègues qui aime travailler sous pression avec le service client derrière son épaule ?

Quelle est cette lubie qui pousserait certains d’entre nous à se faire passer pour le messie en récitant ce mantra ?
...
![](/images/temporarily.png "temporarily")
_\* image venant de [geek and poke](http://geekandpoke.typepad.com/) dont je vous recommande chaudement la lecture._
...
Ok, là je ne vais pas me faire des amis, mais je n'aime pas cette pratique. Inutile de vous répéter, l’info existe déjà dans le gestionnaire de source. On croirait voir des entêtes de fichiers COBOL quand les outils de gestion de source n'étaient pas foutus de faire des annotate sur le code. Franchement, sur la javadoc suivante, en dehors de tenter de se créer un emploi à vie en indiquant haut et fort partout dans le code que vous êtes le seul à pouvoir vous en occuper, quelle est la valeur ? _/\*\*_ _\* DOCUMENT ME_ _\* @ author bidule_ _\*/_
